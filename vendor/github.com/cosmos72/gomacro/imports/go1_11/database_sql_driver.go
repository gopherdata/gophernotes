...
type P_database_sql_driver_Connector struct {
	Object	interface{}
	Connect_	func(interface{}, context.Context) (driver.Conn, error)
	Driver_	func(interface{}) driver.Driver
}
func (P *P_database_sql_driver_Connector) Connect(unnamed0 context.Context) (driver.Conn, error) {
	return P.Connect_(P.Object, unnamed0)
}
func (P *P_database_sql_driver_Connector) Driver() driver.Driver {
	return P.Driver_(P.Object)
}
...
type P_database_sql_driver_DriverContext struct {
	Object	interface{}
	OpenConnector_	func(_proxy_obj_ interface{}, name string) (driver.Connector, error)
}
func (P *P_database_sql_driver_DriverContext) OpenConnector(name string) (driver.Connector, error) {
	return P.OpenConnector_(P.Object, name)
}
...
type P_database_sql_driver_SessionResetter struct {
	Object	interface{}
	ResetSession_	func(_proxy_obj_ interface{}, ctx context.Context) error
}
func (P *P_database_sql_driver_SessionResetter) ResetSession(ctx context.Context) error {
	return P.ResetSession_(P.Object, ctx)
}
