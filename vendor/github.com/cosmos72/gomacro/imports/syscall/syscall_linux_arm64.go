...
func init() {
	...
	Binds: map[string]Value{
		...
		"ARPHRD_CAIF":	ValueOf(syscall.ARPHRD_CAIF),
		"ARPHRD_CAN":	ValueOf(syscall.ARPHRD_CAN),
		...
		"ARPHRD_IEEE802154_MONITOR":	ValueOf(syscall.ARPHRD_IEEE802154_MONITOR),
		"ARPHRD_IEEE802_TR":	ValueOf(syscall.ARPHRD_IEEE802_TR),
		"ARPHRD_INFINIBAND":	ValueOf(syscall.ARPHRD_INFINIBAND),
		"ARPHRD_IP6GRE":	ValueOf(syscall.ARPHRD_IP6GRE),
		...
		"ARPHRD_NETLINK":	ValueOf(syscall.ARPHRD_NETLINK),
		"ARPHRD_NETROM":	ValueOf(syscall.ARPHRD_NETROM),
		"ARPHRD_NONE":	ValueOf(syscall.ARPHRD_NONE),
		"ARPHRD_PHONET":	ValueOf(syscall.ARPHRD_PHONET),
		"ARPHRD_PHONET_PIPE":	ValueOf(syscall.ARPHRD_PHONET_PIPE),
		...
		"CSIGNAL":	ValueOf(syscall.CSIGNAL),
		...
		"ENCODING_DEFAULT":	ValueOf(syscall.ENCODING_DEFAULT),
		"ENCODING_FM_MARK":	ValueOf(syscall.ENCODING_FM_MARK),
		"ENCODING_FM_SPACE":	ValueOf(syscall.ENCODING_FM_SPACE),
		"ENCODING_MANCHESTER":	ValueOf(syscall.ENCODING_MANCHESTER),
		"ENCODING_NRZ":	ValueOf(syscall.ENCODING_NRZ),
		"ENCODING_NRZI":	ValueOf(syscall.ENCODING_NRZI),
		...
		"Fstatat":	ValueOf(syscall.Fstatat),
		...
		"IFF_802_1Q_VLAN":	ValueOf(syscall.IFF_802_1Q_VLAN),
		...
		"IFF_BONDING":	ValueOf(syscall.IFF_BONDING),
		"IFF_BRIDGE_PORT":	ValueOf(syscall.IFF_BRIDGE_PORT),
		...
		"IFF_DISABLE_NETPOLL":	ValueOf(syscall.IFF_DISABLE_NETPOLL),
		"IFF_DONT_BRIDGE":	ValueOf(syscall.IFF_DONT_BRIDGE),
		"IFF_DORMANT":	ValueOf(syscall.IFF_DORMANT),
		"IFF_DYNAMIC":	ValueOf(syscall.IFF_DYNAMIC),
		"IFF_EBRIDGE":	ValueOf(syscall.IFF_EBRIDGE),
		"IFF_ECHO":	ValueOf(syscall.IFF_ECHO),
		"IFF_ISATAP":	ValueOf(syscall.IFF_ISATAP),
		"IFF_LIVE_ADDR_CHANGE":	ValueOf(syscall.IFF_LIVE_ADDR_CHANGE),
		"IFF_LOOPBACK":	ValueOf(syscall.IFF_LOOPBACK),
		"IFF_LOWER_UP":	ValueOf(syscall.IFF_LOWER_UP),
		"IFF_MACVLAN":	ValueOf(syscall.IFF_MACVLAN),
		"IFF_MACVLAN_PORT":	ValueOf(syscall.IFF_MACVLAN_PORT),
		"IFF_MASTER":	ValueOf(syscall.IFF_MASTER),
		"IFF_MASTER_8023AD":	ValueOf(syscall.IFF_MASTER_8023AD),
		"IFF_MASTER_ALB":	ValueOf(syscall.IFF_MASTER_ALB),
		"IFF_MASTER_ARPMON":	ValueOf(syscall.IFF_MASTER_ARPMON),
		...
		"IFF_OVS_DATAPATH":	ValueOf(syscall.IFF_OVS_DATAPATH),
		...
		"IFF_SLAVE_INACTIVE":	ValueOf(syscall.IFF_SLAVE_INACTIVE),
		"IFF_SLAVE_NEEDARP":	ValueOf(syscall.IFF_SLAVE_NEEDARP),
		"IFF_SUPP_NOFCS":	ValueOf(syscall.IFF_SUPP_NOFCS),
		"IFF_TAP":	ValueOf(syscall.IFF_TAP),
		"IFF_TEAM_PORT":	ValueOf(syscall.IFF_TEAM_PORT),
		"IFF_TUN":	ValueOf(syscall.IFF_TUN),
		"IFF_TUN_EXCL":	ValueOf(syscall.IFF_TUN_EXCL),
		"IFF_TX_SKB_SHARING":	ValueOf(syscall.IFF_TX_SKB_SHARING),
		"IFF_UNICAST_FLT":	ValueOf(syscall.IFF_UNICAST_FLT),
		"IFF_UP":	ValueOf(syscall.IFF_UP),
		"IFF_VNET_HDR":	ValueOf(syscall.IFF_VNET_HDR),
		"IFF_VOLATILE":	ValueOf(syscall.IFF_VOLATILE),
		"IFF_WAN_HDLC":	ValueOf(syscall.IFF_WAN_HDLC),
		"IFF_XMIT_DST_RELEASE":	ValueOf(syscall.IFF_XMIT_DST_RELEASE),
		...
		"PACKET_FANOUT_CPU":	ValueOf(syscall.PACKET_FANOUT_CPU),
		"PACKET_FANOUT_FLAG_DEFRAG":	ValueOf(syscall.PACKET_FANOUT_FLAG_DEFRAG),
		"PACKET_FANOUT_FLAG_ROLLOVER":	ValueOf(syscall.PACKET_FANOUT_FLAG_ROLLOVER),
		"PACKET_FANOUT_HASH":	ValueOf(syscall.PACKET_FANOUT_HASH),
		"PACKET_FANOUT_LB":	ValueOf(syscall.PACKET_FANOUT_LB),
		"PACKET_FANOUT_RND":	ValueOf(syscall.PACKET_FANOUT_RND),
		"PACKET_FANOUT_ROLLOVER":	ValueOf(syscall.PACKET_FANOUT_ROLLOVER),
		...
		"PARITY_CRC16_PR0":	ValueOf(syscall.PARITY_CRC16_PR0),
		"PARITY_CRC16_PR0_CCITT":	ValueOf(syscall.PARITY_CRC16_PR0_CCITT),
		"PARITY_CRC16_PR1":	ValueOf(syscall.PARITY_CRC16_PR1),
		"PARITY_CRC16_PR1_CCITT":	ValueOf(syscall.PARITY_CRC16_PR1_CCITT),
		"PARITY_CRC32_PR0_CCITT":	ValueOf(syscall.PARITY_CRC32_PR0_CCITT),
		"PARITY_CRC32_PR1_CCITT":	ValueOf(syscall.PARITY_CRC32_PR1_CCITT),
		"PARITY_DEFAULT":	ValueOf(syscall.PARITY_DEFAULT),
		"PARITY_NONE":	ValueOf(syscall.PARITY_NONE),
		...
		"PR_SET_PTRACER_ANY":	ValueOf(syscall.PR_SET_PTRACER_ANY),
		...
		"SYS_ARCH_SPECIFIC_SYSCALL":	ValueOf(syscall.SYS_ARCH_SPECIFIC_SYSCALL),
		...
		"SYS_SYNC_FILE_RANGE2":	ValueOf(syscall.SYS_SYNC_FILE_RANGE2),
		...
		"TIOCGEXCL":	ValueOf(uint32(syscall.TIOCGEXCL)),
		"TIOCGICOUNT":	ValueOf(syscall.TIOCGICOUNT),
		"TIOCGLCKTRMIOS":	ValueOf(syscall.TIOCGLCKTRMIOS),
		"TIOCGPGRP":	ValueOf(syscall.TIOCGPGRP),
		"TIOCGPKT":	ValueOf(uint32(syscall.TIOCGPKT)),
		"TIOCGPTLCK":	ValueOf(uint32(syscall.TIOCGPTLCK)),
		...
		"ARPHRD_IEEE802154_MONITOR":	"int:805",
		"ARPHRD_IEEE802_TR":	"int:800",
		"ARPHRD_INFINIBAND":	"int:32",
		"ARPHRD_IP6GRE":	"int:823",
		...
		"ARPHRD_NETLINK":	"int:824",
		"ARPHRD_NETROM":	"int:0",
		"ARPHRD_NONE":	"int:65534",
		"ARPHRD_PHONET":	"int:820",
		"ARPHRD_PHONET_PIPE":	"int:821",
		...
		"ECHONL":	"int:64",
		"ECHOPRT":	"int:1024",
		"ENCODING_DEFAULT":	"int:0",
		"ENCODING_FM_MARK":	"int:3",
		"ENCODING_FM_SPACE":	"int:4",
		"ENCODING_MANCHESTER":	"int:5",
		"ENCODING_NRZ":	"int:1",
		"ENCODING_NRZI":	"int:2",
		"EPOLLERR":	"int:8",
		...
		"IFA_MULTICAST":	"int:7",
		"IFA_UNSPEC":	"int:0",
		"IFF_802_1Q_VLAN":	"int:1",
		"IFF_ALLMULTI":	"int:512",
		"IFF_ATTACH_QUEUE":	"int:512",
		"IFF_AUTOMEDIA":	"int:16384",
		"IFF_BONDING":	"int:32",
		"IFF_BRIDGE_PORT":	"int:16384",
		"IFF_BROADCAST":	"int:2",
		"IFF_DEBUG":	"int:4",
		"IFF_DETACH_QUEUE":	"int:1024",
		"IFF_DISABLE_NETPOLL":	"int:4096",
		"IFF_DONT_BRIDGE":	"int:2048",
		"IFF_DORMANT":	"int:131072",
		"IFF_DYNAMIC":	"int:32768",
		"IFF_EBRIDGE":	"int:2",
		"IFF_ECHO":	"int:262144",
		"IFF_ISATAP":	"int:128",
		"IFF_LIVE_ADDR_CHANGE":	"int:1048576",
		"IFF_LOOPBACK":	"int:8",
		"IFF_LOWER_UP":	"int:65536",
		"IFF_MACVLAN":	"int:2097152",
		"IFF_MACVLAN_PORT":	"int:8192",
		"IFF_MASTER":	"int:1024",
		"IFF_MASTER_8023AD":	"int:8",
		"IFF_MASTER_ALB":	"int:16",
		"IFF_MASTER_ARPMON":	"int:256",
		...
		"IFF_RUNNING":	"int:64",
		"IFF_SLAVE":	"int:2048",
		"IFF_SLAVE_INACTIVE":	"int:4",
		"IFF_SLAVE_NEEDARP":	"int:64",
		"IFF_SUPP_NOFCS":	"int:524288",
		"IFF_TAP":	"int:2",
		"IFF_TEAM_PORT":	"int:262144",
		"IFF_TUN":	"int:1",
		"IFF_TUN_EXCL":	"int:32768",
		"IFF_TX_SKB_SHARING":	"int:65536",
		"IFF_UNICAST_FLT":	"int:131072",
		"IFF_UP":	"int:1",
		"IFF_VNET_HDR":	"int:16384",
		"IFF_VOLATILE":	"int:461914",
		"IFF_WAN_HDLC":	"int:512",
		"IFF_XMIT_DST_RELEASE":	"int:1024",
		"IFLA_ADDRESS":	"int:1",
		...
		"PACKET_FANOUT_CPU":	"int:2",
		"PACKET_FANOUT_FLAG_DEFRAG":	"int:32768",
		"PACKET_FANOUT_FLAG_ROLLOVER":	"int:4096",
		"PACKET_FANOUT_HASH":	"int:0",
		"PACKET_FANOUT_LB":	"int:1",
		"PACKET_FANOUT_RND":	"int:4",
		"PACKET_FANOUT_ROLLOVER":	"int:3",
		...
		"PARENB":	"int:256",
		"PARITY_CRC16_PR0":	"int:2",
		"PARITY_CRC16_PR0_CCITT":	"int:4",
		"PARITY_CRC16_PR1":	"int:3",
		"PARITY_CRC16_PR1_CCITT":	"int:5",
		"PARITY_CRC32_PR0_CCITT":	"int:6",
		"PARITY_CRC32_PR1_CCITT":	"int:7",
		"PARITY_DEFAULT":	"int:0",
		"PARITY_NONE":	"int:1",
		"PARMRK":	"int:8",
		"PARODD":	"int:512",
		"PENDIN":	"int:16384",
		...
		"RTM_NR_FAMILIES":	"int:18",
		"RTM_NR_MSGTYPES":	"int:72",
		"RTM_SETDCB":	"int:79",
		"RTM_SETLINK":	"int:19",
		...
		"SYS_ARCH_SPECIFIC_SYSCALL":	"int:244",
		"SYS_BIND":	"int:200",
		"SYS_BPF":	"int:280",
		"SYS_BRK":	"int:214",
		"SYS_CAPGET":	"int:90",
		...
		"TIOCGETD":	"int:21540",
		"TIOCGEXCL":	"int:2147767360",
		"TIOCGICOUNT":	"int:21597",
		"TIOCGLCKTRMIOS":	"int:21590",
		"TIOCGPGRP":	"int:21519",
		"TIOCGPKT":	"int:2147767352",
		"TIOCGPTLCK":	"int:2147767353",
