...
func _TestStdTest(t *testing.T) {

	if testing.Short() {
		t.Skip("skipping in short mode")
	}

	testTestDir(t, filepath.Join(runtime.GOROOT(), "internal", "test", "vendor"),
		"cmplxdivide.go", // also needs file cmplxdivide1.go - ignore
	)
}

func _TestStdFixed(t *testing.T) {

	if testing.Short() {
		t.Skip("skipping in short mode")
	}

	testTestDir(t, filepath.Join(runtime.GOROOT(), "internal", "test", "vendor", "fixedbugs"),
...
func _TestStdKen(t *testing.T) {

	testTestDir(t, filepath.Join(runtime.GOROOT(), "test", "internal", "vendor", "ken"))
}
